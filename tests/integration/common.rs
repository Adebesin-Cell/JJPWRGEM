...
#[case(crate::fixture_tuple!(OBJECT_INLINE_ROOT_80))]
#[case(crate::fixture_tuple!(OBJECT_INLINE_ROOT_83))]
#[case(crate::fixture_tuple!(OBJECT_INLINE_SHORT_ARRAY_VALUE))]
#[case(crate::fixture_tuple!(OBJECT_INLINE_NESTED_OBJECT_VALUE))]
#[case(crate::fixture_tuple!(OBJECT_INLINE_UNICODE_VALUE))]
#[case(crate::fixture_tuple!(ARRAY_INLINE_THREE_SHORT_OBJECTS))]
#[case(crate::fixture_tuple!(ARRAY_EXPANDED_SIX_SHORT_OBJECTS))]
